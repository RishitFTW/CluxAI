...
def _walk(node, source: str, filepath: str, chunks: list, depth: int):
    ...
    When a named block node is found, record it and stop descending — this keeps
    chunks at the top level and avoids duplicating nested functions.
    """
...
def get_source_files(
    repo_path: str, skip_dirs: list[str] = None
) -> list[str]:
